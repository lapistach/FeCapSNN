...
This repository contains the origin codes and TensorBoard logs for the paper [TBD](https://fr.wikipedia.org/wiki/TBD). The training of the SNN is described in [this work](https://github.com/fangwei123456/Parametric-Leaky-Integrate-and-Fire-Spiking-Neuron/) from Fang et al. who implemented this architecture originally. In this work, all the code is implemented in Jupyter Notebooks on Google Colab and was run on the A100 GPUs offered by Colab.
